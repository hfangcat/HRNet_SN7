...
def create_trainval_list(root):
    ...
    """
    # val_aois: 5 AOIs (10%)
    # North America: 1; South America: 1; Europe: 1; Africa: 1; Asia: 1
    val_aois = set(["L15-0357E-1223N_1429_3296_13",
                    "L15-0683E-1006N_2732_4164_13",
                    "L15-1014E-1375N_4056_2688_13",
                    "L15-1204E-1204N_4819_3372_13",
                    "L15-1669E-1160N_6679_3549_13"])
    # Save to .lst files
    fw1 = open("data/list/spacenet7/train.lst", 'w')
    fw2 = open("data/list/spacenet7/val.lst", 'w')
...
def create_test_list(root):
    ...
    """
    # Save to .lst file
    fw = open("data/list/spacenet7/test.lst", 'w')
    for aoi in os.listdir(root):
        if not os.path.isdir(os.path.join(root, aoi)):
            continue
        img_path = os.path.join(root, aoi, "images_masked_3x_divide")
        for img_file in os.listdir(img_path):
            ...
            # withdraw dummy.tif
            fw.write(os.path.join(aoi, "images_masked_3x_divide", img_file) + '\n')
    fw.close()
