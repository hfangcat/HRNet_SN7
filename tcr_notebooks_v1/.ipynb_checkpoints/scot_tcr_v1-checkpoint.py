...
# pred = pd.read_csv('/Midgard/home/hfang/temporal_CD/HRNet_SN7/submission_tcr_v1_alpha_05.csv')
pred = pd.read_csv('/Midgard/home/hfang/temporal_CD/HRNet_SN7/submission_tcr_v1_alpha_09.csv')
# pred = pd.read_csv('/Midgard/home/hfang/temporal_CD/HRNet_SN7/submission_tcr_v1_alpha_1.csv')
...
# df.to_csv('scot_alpha_1.csv', index=False, header=True)
